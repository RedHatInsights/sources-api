...
RSpec.describe("v1.0 - Endpoints") do
  ...
  describe("/api/v1.0/endpoints") do
    context "get" do
    ...
    context "post" do
      it "success: with valid body" do
        ...
        expect(response).to have_attributes(
          :status => 201,
          :location => "http://www.example.com/api/v1.0/endpoints/#{response.parsed_body["id"]}",
  ...
  describe("/api/v1.0/endpoints/:id") do

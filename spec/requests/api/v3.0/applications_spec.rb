RSpec.describe("v3.0 - Applications") do
  ...
  describe("/api/v3.0/applications") do
    context "get" do
    ...
    context "post" do
      it "success: with valid body" do
        ...
        expect(response).to have_attributes(
          :status => 201,
          :location => "http://www.example.com/api/v3.0/applications/#{response.parsed_body["id"]}",
  ...
  describe("/api/v3.0/applications/:id") do

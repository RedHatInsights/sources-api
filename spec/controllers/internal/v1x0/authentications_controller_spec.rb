RSpec.describe Internal::V1x0::AuthenticationsController, :type => :request do
  ...
  it "GET an instance" do
    get(internal_v1x0_authentication_url(authentication.id))
  ...
  it "GET an instance exposing password" do
    get(internal_v1x0_authentication_url(authentication.id), :params => {"expose_encrypted_attribute[]" => "password"})
